...
const ListAnimeImageBackground = ({title, genre, rating, ImgBackground}) => {
  return (
    <>
        <ImageBackground source={{uri: ImgBackground}} style={{height: '100%', maxHeight: 200, width: 150, backgroundColor: '#000', borderRadius: 15, overflow: 'hidden', position: 'relative'}}>
...
export default ListAnimeImageBackground